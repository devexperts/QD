...
import static com.devexperts.util.benchmark.TimeFormat.CACHE_MILLIS_AND_MINUTES;
import static com.devexperts.util.benchmark.TimeFormat.CACHE_SHARED_ARRAY_MASK;
import static com.devexperts.util.benchmark.TimeFormat.CACHE_SHARED_BIN_MASK;
import static com.devexperts.util.benchmark.TimeFormat.CACHE_SHARED_REMAINDER;
import static com.devexperts.util.benchmark.TimeFormat.NO_CACHE;
...
public class TimeFormatBenchmark {
    ...
    @Param({
        NO_CACHE,
        CACHE_SHARED_BIN_MASK,
        CACHE_SHARED_REMAINDER,
        CACHE_SHARED_ARRAY_MASK,
        CACHE_MILLIS_AND_MINUTES,
        PRODUCTION_IMPL
    })
