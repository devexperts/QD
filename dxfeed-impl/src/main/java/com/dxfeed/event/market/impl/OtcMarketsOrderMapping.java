...
public class OtcMarketsOrderMapping extends OrderBaseMapping {
// BEGIN: CODE AUTOMATICALLY GENERATED: DO NOT MODIFY. IT IS REGENERATED BY com.dxfeed.api.codegen.ImplCodeGen
    ...
    private final int iQuoteAccessPayment;
    private final int iOtcMarketsFlags;

    public OtcMarketsOrderMapping(DataRecord record) {
        super(record);
        ...
        iQuoteAccessPayment = MappingUtil.findIntField(record, "QuoteAccessPayment", true);
        iOtcMarketsFlags = MappingUtil.findIntField(record, "OtcMarketsFlags", true);
    ...
    public int getQuoteAccessPayment(RecordCursor cursor) {
        return getInt(cursor, iQuoteAccessPayment);
    }

    public void setQuoteAccessPayment(RecordCursor cursor, int quoteAccessPayment) {
        setInt(cursor, iQuoteAccessPayment, quoteAccessPayment);
    }

    public int getOtcMarketsFlags(RecordCursor cursor) {
        return getInt(cursor, iOtcMarketsFlags);
    }

    public void setOtcMarketsFlags(RecordCursor cursor, int otcMarketsFlags) {
        setInt(cursor, iOtcMarketsFlags, otcMarketsFlags);
    }
