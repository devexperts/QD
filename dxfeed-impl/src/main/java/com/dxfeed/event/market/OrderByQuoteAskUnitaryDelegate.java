...
public final class OrderByQuoteAskUnitaryDelegate extends OrderBaseDelegateImpl<Order> {
// BEGIN: CODE AUTOMATICALLY GENERATED: DO NOT MODIFY. IT IS REGENERATED BY com.dxfeed.api.codegen.ImplCodeGen
    private final QuoteMapping m;

    public OrderByQuoteAskUnitaryDelegate(DataRecord record, QDContract contract, EnumSet<EventDelegateFlags> flags) {
    ...
    public Order getEvent(Order event, RecordCursor cursor) {
        ...
        event.setIndex(((long) getSource().id() << 48) | 0L << 47 | ((long) (m.getRecordExchange() & 0x7FFF) << 32));
