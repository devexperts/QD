...
public final class OrderByMarketMakerBidUnitaryDelegate extends OrderBaseDelegateImpl<Order> {
// BEGIN: CODE AUTOMATICALLY GENERATED: DO NOT MODIFY. IT IS REGENERATED BY com.dxfeed.api.codegen.ImplCodeGen
    private final MarketMakerMapping m;

    public OrderByMarketMakerBidUnitaryDelegate(DataRecord record, QDContract contract, EnumSet<EventDelegateFlags> flags) {
    ...
    public Order getEvent(Order event, RecordCursor cursor) {
        ...
        event.setIndex(((long) getSource().id() << 48) | 1L << 47 | ((m.getExchangeCode(cursor) & 0x7FFFL) << 32) | (m.getMarketMaker(cursor) & 0xFFFFFFFFL));
