...
public class NuamTradeMapping extends MarketEventMapping {
// BEGIN: CODE AUTOMATICALLY GENERATED: DO NOT MODIFY. IT IS REGENERATED BY com.dxfeed.api.codegen.ImplCodeGen
    ...
    private final int iNumberOfTrades;
    private final int iVWAP;

    public NuamTradeMapping(DataRecord record) {
        super(record);
        ...
        iNumberOfTrades = MappingUtil.findIntField(record, "NumberOfTrades", true);
        iVWAP = findIntField("VWAP", true);
    ...
    public long getTradeStatTimeMillis(RecordCursor cursor) {
        return getLong(cursor, iTradeStatTime);
    }

    public void setTradeStatTimeMillis(RecordCursor cursor, long tradeStatTime) {
        setLong(cursor, iTradeStatTime, tradeStatTime);
    }

    public int getTradeStatTimeSeconds(RecordCursor cursor) {
        return TimeUtil.getSecondsFromTime(getLong(cursor, iTradeStatTime));
    }

    public void setTradeStatTimeSeconds(RecordCursor cursor, int tradeStatTime) {
        setLong(cursor, iTradeStatTime, tradeStatTime * 1000L);
    }

    public double getLastSignificantPrice(RecordCursor cursor) {
        return getAsDouble(cursor, iLastSignificantPrice);
    }

    public void setLastSignificantPrice(RecordCursor cursor, double lastSignificantPrice) {
        setAsDouble(cursor, iLastSignificantPrice, lastSignificantPrice);
    }

    public int getLastSignificantPriceDecimal(RecordCursor cursor) {
        return getAsTinyDecimal(cursor, iLastSignificantPrice);
    }

    public void setLastSignificantPriceDecimal(RecordCursor cursor, int lastSignificantPrice) {
        setAsTinyDecimal(cursor, iLastSignificantPrice, lastSignificantPrice);
    }

    public long getLastSignificantPriceWideDecimal(RecordCursor cursor) {
        return getAsWideDecimal(cursor, iLastSignificantPrice);
    }

    public void setLastSignificantPriceWideDecimal(RecordCursor cursor, long lastSignificantPrice) {
        setAsWideDecimal(cursor, iLastSignificantPrice, lastSignificantPrice);
    }

    public double getLastPriceForAll(RecordCursor cursor) {
        return getAsDouble(cursor, iLastPriceForAll);
    }

    public void setLastPriceForAll(RecordCursor cursor, double lastPriceForAll) {
        setAsDouble(cursor, iLastPriceForAll, lastPriceForAll);
    }

    public int getLastPriceForAllDecimal(RecordCursor cursor) {
        return getAsTinyDecimal(cursor, iLastPriceForAll);
    }

    public void setLastPriceForAllDecimal(RecordCursor cursor, int lastPriceForAll) {
        setAsTinyDecimal(cursor, iLastPriceForAll, lastPriceForAll);
    }

    public long getLastPriceForAllWideDecimal(RecordCursor cursor) {
        return getAsWideDecimal(cursor, iLastPriceForAll);
    }

    public void setLastPriceForAllWideDecimal(RecordCursor cursor, long lastPriceForAll) {
        setAsWideDecimal(cursor, iLastPriceForAll, lastPriceForAll);
    }

    public int getNumberOfTrades(RecordCursor cursor) {
        return getInt(cursor, iNumberOfTrades);
    }

    public void setNumberOfTrades(RecordCursor cursor, int numberOfTrades) {
        setInt(cursor, iNumberOfTrades, numberOfTrades);
    }
